...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    items: [
      ...
      "通告排表模式（製片版）：專案頁「＋ 通告排表」＝只有甘特／通告單／Rundown 的輕量案；側欄底部可隨時切換完整 PPM ⇄ 通告排表，同一份檔案、資料一個不少",
      "匯入外部分鏡圖：「對照分鏡」選擇器內「＋ 匯入分鏡圖」——腳本是別的軟體做的也沒關係，圖檔多選一次帶進來、每張自動變一顆 cut（依檔名排序、自動裁 16:9），馬上指派給時段",
    ],
  },
  {
    version: "1.0.0",
